...
var connection = new(cradle.Connection)(vcap.credentials.host, vcap.credentials.port, { auth: { username: vcap.credentials.username, password: vcap.credentials.password }
});
